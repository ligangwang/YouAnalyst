...
export const MarketContext = createContext<MarketContextValue>({ active: false, market: "ALL", saving: false, error: false, change: async preferences => applyPreferences(preferences) });
